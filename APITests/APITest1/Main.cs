    ...
    *  in HP Service Test.
    ...
    {    
        ...
        internal void InitializeComponent()
        {
            ...
            _flow.Sequence5.Activities.Add (_flow.CallQTPTest4);
            _flow.CallQTPTest4.Comment = @"";
            _flow.CallQTPTest4.IconPath = @"AddIns\ServiceTest\UFT\toolbox_qtp.png";
            _flow.CallQTPTest4.Name = @"AllPurposes";
            _flow.CallQTPTest4.ScriptPath = String.IsNullOrEmpty(_context.ResourceManager.GetValue(@"{Step.GeneralProperties.CallQTPTest4.ScriptPath}")) ? @"..\AllPurposes" : _context.ResourceManager.GetValue(@"{Step.GeneralProperties.CallQTPTest4.ScriptPath}");
            _flow.CallQTPTest4.ActionName = String.IsNullOrEmpty(_context.ResourceManager.GetValue(@"{Step.GeneralProperties.CallQTPTest4.ActionName}")) ? @"" : _context.ResourceManager.GetValue(@"{Step.GeneralProperties.CallQTPTest4.ActionName}");
